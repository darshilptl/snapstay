          ...
          <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 ">
            <div>
              ...
              <div className="mt-6">
                ...
                <p className="mt-4 text-lg text-gray-950  dark:text-white">
                  At SnapStay, we offer more than just a place to stay – we
                  provide a seamless and personalized experience from easy
                  bookings to responsive support. Whether it's a cozy getaway or
                  a luxurious escape, our services ensure every detail is
                  handled, making your stay unforgettable from start to finish.
                </p>
                <div className="mt-6">
                  <Link
                    className="inline-flex rounded-lg bg-pink-600 px-4 py-1.5 text-base font-semibold leading-7 text-gray-950 dark:text-white shadow-sm ring-1 ring-pink-600 hover:bg-pink-700 hover:ring-pink-700"
                    href="#"
                  >
                    Learn More
                  </Link>
          ...
          <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 lg:col-start-2">
            <div>
              ...
              <div className="mt-6">
                ...
                <p className="mt-4 text-lg text-gray-950 dark:text-white">
                  At SnapStay, we prioritize your safety with secure, encrypted
                  payment processing, ensuring your personal and financial
                  information is always protected. Enjoy hassle-free bookings
                  with confidence, knowing every transaction is safeguarded by
